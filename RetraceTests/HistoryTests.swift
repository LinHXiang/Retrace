...
class HistoryTests: XCTestCase {
  ...
  func testAddingItemThatIsSupersededByExisting() {
    ...
    firstItem.application = "Retrace.app"
    ...
    secondItem.application = "Retrace.app"
  ...
  func testAddingItemFromRetrace() {
    let firstContents = [
      HistoryItemContent(
        type: NSPasteboard.PasteboardType.string.rawValue,
        value: "one".data(using: .utf8)
    ...
    let secondContents = [
      ...
      HistoryItemContent(
        type: NSPasteboard.PasteboardType.fromRetrace.rawValue,
        value: "".data(using: .utf8)
      )
    ]
    let second = HistoryItem()
    Storage.shared.context.insert(second)
    second.application = "Retrace.app"
