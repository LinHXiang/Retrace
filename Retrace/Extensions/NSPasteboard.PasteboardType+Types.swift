...
extension NSPasteboard.PasteboardType: Defaults.Serializable {
  ...
  // https://github.com/p0deje/Retrace/issues/429#issuecomment-1182575226
  static let modified = NSPasteboard.PasteboardType(rawValue: "x.nspasteboard.ModifiedType")

  // Marks that copy was made from Retrace.
  static let fromRetrace = NSPasteboard.PasteboardType(rawValue: "com.freeorz.retrace")
