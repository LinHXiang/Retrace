...
class Popup {
  ...
  static let minimumWidthWithPreview: CGFloat = minimumListWidth + previewWidth + horizontalPadding * 2
  ...
  func preferredHeight(for newHeight: CGFloat) -> CGFloat {
    ...
    let minimumHeight = headerHeight + Self.verticalPadding
  ...
  private func handleFirstKeyDown() {
    ...
    // Retrace was not opened via shortcut. We assume toggle mode and close it
    close()
  }
